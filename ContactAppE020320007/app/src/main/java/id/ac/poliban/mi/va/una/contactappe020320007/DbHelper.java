package id.ac.poliban.mi.va.una.contactappe020320007;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public DbHelper(@Nullable Context context) {
        super(context, id.ac.poliban.mi.va.una.contactappe020320007.Constants.DATABASE_NAME, null, Constants.DATABASE_VERSION);
    }
